...
Clone this repository and install the dependencies.
    ...
    $ git clone https://github.com/sahaktadevosyan89/CMS-Laravel-5.git CUSTOM_DIRECTORY && cd CUSTOM_DIRECTORY
    $ composer install
...
Either Clone the repository using git clone: `git clone https://github.com/sahaktadevosyan89/CMS-Laravel-5.git CUSTOM_DIRECTORY` or install via <a target="_blank" href="https://github.com/sahaktadevosyan89/CMS-Laravel-5.git/archive/master.zip">zip</a> and extract to any of your folders you wish.
